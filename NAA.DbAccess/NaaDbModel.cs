    ...
    public class NaaDbModel : DbContext
    {
        ...
        public NaaDbModel()
        {
            ...
            Database.Connection.ConnectionString =
                "data source=Julian-Notebook;initial catalog=NAA5;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework";
        }
        ...
        {
            modelBuilder.Entity<Application>().HasRequired(x => x.Applicant).WithMany(x => x.Applications)
